...
LICENSE="0BSD Apache-2.0 Apache-2.0-with-LLVM-exceptions Artistic-2 BSD BSD-2 Boost-1.0 CC0-1.0 GPL-2 ISC MIT MPL-2.0 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"
...
src_install() {
	...
	newicon -s 1024 extra/images/logo.png dev.lapce.lapce.png
	newicon -s scalable extra/images/logo.svg dev.lapce.lapce.svg
}
