...
"
RUST_MIN_VER="1.88.0"
# TODO: pack ${P}-crates.tar.xz
inherit desktop cargo fcaps xdg
...
FILECAPS=(
	cap_net_raw,cap_net_admin=eip usr/bin/sniffnet
)

src_install() {
	cargo_src_install

	# 8 42 160 384 is unsupported icon sizes
	for size in 16 22 24 32 36 48 64 72 96 128 192 256 512 1024; do
		newicon -s "${size}" "${S}/resources/packaging/linux/graphics/sniffnet_${size}x${size}.png" "${PN}.png"
	done
	domenu "${S}/resources/packaging/linux/${PN}.desktop"
}
