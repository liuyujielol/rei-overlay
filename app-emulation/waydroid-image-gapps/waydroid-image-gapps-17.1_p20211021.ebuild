...
SRC_URI="
	amd64? (
	https://sourceforge.net/projects/waydroid/files/images/system/lineage/waydroid_x86_64/lineage-${MY_PV}-GAPPS-waydroid_x86_64-system.zip
	...
	arm? (
	https://sourceforge.net/projects/waydroid/files/images/system/lineage/waydroid_arm/lineage-17.1-20211020-GAPPS-waydroid_arm-system.zip
	https://sourceforge.net/projects/waydroid/files/images/vendor/waydroid_arm/lineage-${MY_PV}-MAINLINE-waydroid_arm-vendor.zip
	)
	arm64? (
	https://sourceforge.net/projects/waydroid/files/images/system/lineage/waydroid_arm64/lineage-${MY_PV}-GAPPS-waydroid_arm64-system.zip
	...
	x86? (
	https://sourceforge.net/projects/waydroid/files/images/system/lineage/waydroid_x86/lineage-${MY_PV}-GAPPS-waydroid_x86-system.zip
